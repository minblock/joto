...
#include "config/jotocoin-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatJOTOCOINURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + JOTOCOINUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatJOTOCOINURI(info));
}
