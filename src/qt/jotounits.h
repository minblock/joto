...
#ifndef JOTO_QT_JOTOUNITS_H
#define JOTO_QT_JOTOUNITS_H
...
/** JOTO unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class JOTOUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit JOTOUnits(QObject *parent);

    /** JOTO units.
      @note Source: https://en.joto.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        JOTO,
...
typedef JOTOUnits::Unit JOTOUnit;

#endif // JOTO_QT_JOTOUNITS_H
