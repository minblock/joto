#ifndef JOTOCOIN_CHAINPARAMSSEEDS_H
#define JOTOCOIN_CHAINPARAMSSEEDS_H
/**
 * List of fixed seed nodes for the jotocoin network
...
#endif // JOTOCOIN_CHAINPARAMSSEEDS_H
