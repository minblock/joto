 ...
 * for both jotod and joto-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("JOTO Core");
...
/** 
 * Format the subversion field according to BIP 14 spec (https://github.com/joto/bips/blob/master/bip-0014.mediawiki) 
 */
