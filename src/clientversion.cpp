 ...
 * for both jotocoind and jotocoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("JOTOCOIN Core");
...
/** 
 * Format the subversion field according to BIP 14 spec (https://github.com/jotocoin/bips/blob/master/bip-0014.mediawiki) 
 */
