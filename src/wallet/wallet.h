...
#ifndef JOTOCOIN_WALLET_WALLET_H
#define JOTOCOIN_WALLET_WALLET_H
...
public:
    ...
    /// Get 1000JOTOCOIN output and keys which can be used for the Masternode
...
#endif // JOTOCOIN_WALLET_WALLET_H
