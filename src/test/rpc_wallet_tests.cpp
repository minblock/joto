...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CJOTOAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CJOTOAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CJOTOAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CJOTOAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CJOTOAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CJOTOAddress(arr[0].get_str()).Get() == demoAddress.Get());
