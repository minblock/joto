...
#define BOOST_TEST_MODULE JOTOCOIN Test Suite

#include "test_jotocoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_jotocoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
