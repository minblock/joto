...
#ifndef JOTO_TEST_SCRIPTNUM10_H
#define JOTO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from JOTO Core 0.10.0, for cross-comparison.
 */
public:
