...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "JOTOCOINNetwork") type = JOTOCOINNetwork;
    if(strType == "JOTOCOINNetworkVariable") type = JOTOCOINNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == JOTOCOINNetwork) s = "JOTOCOINNetwork";
    if(type == JOTOCOINNetworkVariable) s = "JOTOCOINNetworkVariable";
