 ...
 */
#ifndef JOTOCOIN_UTIL_H
#define JOTOCOIN_UTIL_H
...
//#define ENABLE_JOTOCOIN_DEBUG
#ifdef ENABLE_JOTOCOIN_DEBUG
#define DBG( x ) x
#else
#define DBG( x ) 
#endif
...
extern const char * const JOTOCOIN_CONF_FILENAME;
extern const char * const JOTOCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("jotocoin-%s", name);
