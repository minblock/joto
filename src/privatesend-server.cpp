...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all JOTO related functionality
...
/*
    ...
    allow endless transaction that would bloat JOTO and make it unusable. To
