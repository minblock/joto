...
#ifndef JOTOCOIN_NET_H
#define JOTOCOIN_NET_H
...
public:
    ...
    // Unfortunately, can't make this method private like in JOTOCOIN,
    // because it's used in many JOTOCOIN-specific places (masternode, privatesend).
