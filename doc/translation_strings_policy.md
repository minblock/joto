...
This document provides guidelines for internationalization of the JOTO Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `joto_en.ts` remains unchanged.
