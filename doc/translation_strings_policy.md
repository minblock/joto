...
This document provides guidelines for internationalization of the JOTOCOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `jotocoin_en.ts` remains unchanged.
