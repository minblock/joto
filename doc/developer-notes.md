...
JOTOCOIN Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- JOTOCOINMiner : Generates coins (if wallet is enabled).
...
However, in open source software such as JOTOCOIN Core, where everyone uses
...
pay attention to for reviewers of JOTOCOIN Core code.

General JOTOCOIN Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: JOTOCOIN Core uses tinyformat, which is type safe. Leave them out to avoid confusion
