...
JOTO Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- JOTOMiner : Generates coins (if wallet is enabled).
...
However, in open source software such as JOTO Core, where everyone uses
...
pay attention to for reviewers of JOTO Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: JOTO Core uses tinyformat, which is type safe. Leave them out to avoid confusion
