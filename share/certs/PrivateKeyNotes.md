...
unlocked to sign the JOTO-Qt.app bundle.
...
allowing somebody to distribute a JOTO-Qt.app or joto-qt-setup.exe with a valid
...
that the joto-qt.exe file inside the installer had not been tampered with.
